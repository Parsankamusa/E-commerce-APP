                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="#c4" class="nav-link menu-title">Contact Us</a>
                                            </li>
                                            <li><a href="#c4" class="nav-link menu-title">Blog</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +2547789837/span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Nairobi,
                                            kenya</span></span>
                                </li>
                                <li>
                    ...
                    <div  class="col-xl-3 col-lg-4 col-sm-6 d-none d-sm-block">
                        <div id="c4" class="footer-newsletter">
