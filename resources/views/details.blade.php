                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <div class="product-buttons">
                                    <a href="javascript:void(0)" onclick="event.preventDefault(); addProductsToWishList({{ $product->id }}, '{{ $product->name }}', 1, {{ $product->regular_price }});" class="btn btn-solid">
                                ...
                                <ul class="product-count shipping-order">
                                    <li>
                                        <img src="../assets/images/gif/truck.png" class="img-fluid blur-up lazyload"
                                            alt="image">
                                        <span class="lang">Free delivery for orders above $500 USD</span>
                                    </li>
                                </ul>
                                    ...
                                    <div class="customer-review-box">
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="font-light">i enjoyed shoping with you.</p>

                                                <p class="date-custo font-light">- jan 09 2024</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="date-custo font-light">- feb 08, 2024</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="font-light">Love the brands offered</p>

                                                <p class="date-custo font-light">- feb 23, 2021</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="font-light">I purchased the hoodies 
                                                     but it wasn't the color i ordered
                                                     is it a wrong deivery?.</p>

                                                <p class="date-custo font-light">- jan 15, 2024</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                <div class="rating-details">
                                    <span class="font-light grid-content">hoodies</span>
