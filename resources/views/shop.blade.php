...
<section class="breadcrumb-section section-b-space" style="padding-top:20px;padding-bottom:20px;">
                                        ...
                                        <ul class="category-list">
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">airfoce</label>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">kenyan made</label>
                                                    <p class="font-light">(2)</p>
                                                </div>
                                            </li>
                                        ...
                                        <ul class="category-list">
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">hoodies</label>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">dresses</label>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">kits</label>
                                                    <p class="font-light">(0)</p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">sweaters</label>
                                                    <p class="font-light">(5)</p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">gym kits</label>
                                                    <p class="font-light">(4)</p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">skaters</label>
                                                    <p class="font-light">(0)</p>
                                                </div>
                                            </li>
                                        </ul>
                            ...
                            <div class="filter-options">
                                <div class="select-options">
                                    ...
                                    <select class="form-select" name="size" id="pagesize">
                                            ...
                                            <option value="20" {{ $size == 20 ? 'selected':'' }}>20 Products Per Page</option>
                                            <option value="45" {{ $size == 50 ? 'selected':'' }}>45 Products Per Page</option>
    ...
    <!-- Product Sorting and Products Per Page form -->
    <div id="qvmodal"></div>
...
@endsection
<!-- Product Sorting and Products Per Page scripts -->
        @push('scripts')
        <script>
